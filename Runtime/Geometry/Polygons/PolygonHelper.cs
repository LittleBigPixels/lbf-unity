...
using LBF.ThirdParties;
using UnityEngine;
using UnityEngine.Profiling;
using Path = System.Collections.Generic.List<LBF.ThirdParties.IntPoint>;
using Paths = System.Collections.Generic.List<System.Collections.Generic.List<LBF.ThirdParties.IntPoint>>;

namespace LBF.Geometry.Polygons
{
    public static class PolygonHelper
    {
        ...
        public static Vector2 ClosestOnPolygon(Polygon polygon, Vector2 position, out int segmentIndex)
        {
            segmentIndex = 0;
            float dist = float.MaxValue;
            Vector2 bestPoint = Vector2.zero;
