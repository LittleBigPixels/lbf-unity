...
namespace LBF.Math.Geometry.PolygonGraph.Voronoi
{
    /// <summary>
    ...
    public class Voronoi
    {
        ...
        {
            sites = null;
            allEdges = new List<GraphEdge>(xValuesIn.Length * 2);
            ...
            sqrt_nsites = (int)System.Math.Sqrt(sn);
        ...
        private void clip_line(Edge e)
        {
            ...
            if (System.Math.Sqrt((x * x) + (y * y)) < minDistanceBetweenSites)
            {
                return;
            }
            pxmin = borderMinX;
